...
VENDORS = [
    {
        ...
        "desc": "tinyux is a small self-hosted alternative when you need targeted UX events and contextual surveys, not heatmaps or session replay.",
        ...
        "differs": "tinyux does not do heatmaps or replay. It records selected interaction signals and micro-survey answers, then posts them to your own collector. The trade is simple: less product, less data surface, more ownership.",
        "choose_them": "you need heatmaps, replay, funnel views, feedback widgets, and a managed workspace for non-technical teammates.",
        "choose_us": "you only need to instrument important moments, ask contextual questions, and keep raw data on your server.",
        "rows": [
            ("Heatmaps", "No", "Yes"),
    ...
    },
    {
        ...
        "differs": "tinyux is intentionally narrower. It does not reconstruct sessions or provide a search UI. It records the events you choose and the answers users submit, then leaves analysis to your database or internal tools.",
    ...
    },
    {
        ...
        "differs": "tinyux skips the debugging recorder. It is useful when the question is not 'recreate the bug' but 'what did users click, where did they hesitate, and what did they say at that moment?'",
        "choose_them": "you need replay, console/network context, error triage, and engineering workflows around user sessions.",
        "choose_us": "you want small event telemetry and surveys without capturing debug streams or replayable sessions.",
        "rows": [
            ("Replay", "No", "Yes"),
    ...
    },
    {
        ...
        "differs": "tinyux is not trying to be a product operating system. It captures lightweight events and survey answers, then stores them where you decide.",
